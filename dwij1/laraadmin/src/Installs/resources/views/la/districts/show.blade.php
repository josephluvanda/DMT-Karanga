...
<div id="page-content" class="profile2">
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/districts') }}" data-toggle="tooltip" data-placement="right" title="Back to Regions"><i class="fa fa-chevron-left"></i></a></li>
