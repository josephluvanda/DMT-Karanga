...
class LAInstall extends Command
{
	...
	public function handle()
	{
		try {
			...
			$from = base_path('packages/code4tz/laraadmin/src/Installs');
			$to = base_path();
        ...
        if( $appModels != null OR !empty($appModels)){
          $this->modelsInstalled = array_merge($this->modelsInstalled, $appModels);
				...
				*/
				...
				$this->copyFolder($from."/seeds", $to."/database/seeds");
