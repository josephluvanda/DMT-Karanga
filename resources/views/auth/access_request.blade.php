...
@section('content')
    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            <p class="login-box-msg">Access Request</p>
            <form action="{{ url('/access_request') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <textarea name="registration_reason" class="form-control" placeholder="Registration Reason"></textarea>
                </div>
                <div class="row">
                    <div class="col-xs-8">
                        <div class="checkbox icheck">
                            <label>
                                <!--<input required="required" type="checkbox"> I agree to the terms-->
                            </label>
                        </div>
                    </div><!-- /.col -->
                    <div class="col-xs-4">
            ...
            <hr>
            <center><a href="{{ url('/') }}" class="text-center">Back to Homepage</a></center>
        </div><!-- /.form-box -->
    </div><!-- /.register-box -->
